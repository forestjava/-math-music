...
export function sessionStartPrompt(runtime: SessionRuntime): string {
  ...
  return (
    ...
    //`\n\nСегодняшний герой должен отправиться на поиски некой пирамиды, которая питается страданиями людей, как энергией. Он должен разрушить этот адский конструкт.\n\n` +
