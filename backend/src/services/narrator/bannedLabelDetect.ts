...
const BANNED_LABELS = [
  ...
  "когда-то", 
  "неопределенность", 
  "неопределённый", "неопределённого", "неопределённому", "неопределённым", "неопределённом", 
  "неопределённая", "неопределённой", "неопределённую",
  "неопределённое", 
  "неопределённые", "неопределённых", "неопределённым", "неопределённых", "неопределёнными",
  "испытание",
  "ордалия",
  "дар",
  "эликсир",
